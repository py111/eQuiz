<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		$idQuizMaker = $quizMakerDAO->authenticate($_POST['user'],$_POST['password']);
		
		if($idQuizMaker <=0){
			$error ="Username/password not found";
		}else{
			session_start();
			$_SESSION['id_quiz_maker'] = $idQuizMaker;
			header("Location: makerArea.php");
			return;	
		}
...
<div id="header">
        ...
        <div class="menuBoton">E-Quiz - QuizMaker Login</div>
    ...
    <div id="footer">
	 ...
	 <div id="alertBar"><?php echo $error; ?></div>
        ...
        <div id="contenidoInterior" class="contenidoInterior" style="text-align:center">
       		...
       		<form method="post" action="makerLogin.php">
